...
public class Decompress {
  ...
  public Decompress(String zipFile, String location) { 
   ...
   /* File f1 = new File("/storage/emulated/0/Download/un/");
    deleteRecursive(f1);
      File f2 = new File("/storage/emulated/0/Download/unz/");
      deleteRecursive(f2);
      File f3 = new File("/storage/emulated/0/Download/unzi/");
      deleteRecursive(f3);
      File f4 = new File("/storage/emulated/0/Download/unzippedepub/");
      deleteRecursive(f4);*/
  }
